...
* 📺 **YouTube Voice Control** - Play, pause, skip, seek with voice or text commands
* 𝕏 **X Spaces Integration** - Listen to Twitter/X Spaces with voice commands
...
| 📺 **YouTube Voice Control**    | Play, pause, skip, seek videos with voice commands        |
| 𝕏 **X Spaces Integration**     | Listen to Twitter/X Spaces via voice commands             |
...
1. Click the **📺 YouTube** button in the quick actions bar to show the player
...
YouTube normally stops when your screen turns off. We have two workarounds:

| Feature | How to Use | Notes |
|---------|------------|-------|
| **🔆 Keep Screen On** | Click "Screen" button in player | Uses Wake Lock API to prevent screen timeout |
| **📱 Picture-in-Picture** | Click "PiP" button | Opens video in floating window (works when switching apps) |
...
├─────────────────────────────────────┤
│  ⏮️  ⏪  ⏸️  ▶️  ⏩  ⏭️  ⏹️        │
│ Prev -10s Pause Play +10s Next Stop │
└─────────────────────────────────────┘
```
...
## 𝕏 X Spaces Integration

Listen to X (Twitter) Spaces directly from NEMOTRON AI!

### Quick Start

1. Click the **𝕏 Spaces** button in the quick actions bar
2. Enter a Space URL, username, or search term
3. Or use voice: "listen to spaces from @elonmusk"

### Voice & Text Commands

| Command | Examples | Action |
|---------|----------|--------|
| **Open Space URL** | `play x space https://x.com/i/spaces/xxx` | Opens specific Space |
| **Find User's Spaces** | `listen to spaces from @username` | Opens user's profile |
| **Search Spaces** | `open space crypto talk` | Searches for Spaces |
| **Browse Spaces** | `show X spaces` | Opens Spaces discovery |

### Features

- **⭐ Favorites**: Save usernames who frequently host Spaces
- **🔍 Quick Search**: Find Spaces from your favorite hosts
- **🎧 One-Click Listen**: Opens Spaces in new tab for full functionality

### Voice Examples

```
You: "Listen to spaces from @lexfridman"
AI: "Opening @lexfridman's profile for Spaces."
    [Opens X profile in new tab]

You: "Open X space https://x.com/i/spaces/1ABC..."
AI: "Opening X Space."
    [Opens Space directly]

You: "Show X spaces"
AI: "Opening X Spaces discovery."
    [Opens Spaces browse page]
```

### Notes

- X Spaces open in a **new browser tab** (X doesn't allow embedding)
- Add frequently-used hosts to **Favorites** for quick access
...
FastAPI Server (Uvicorn)
   ...
   ├─ YouTube Command Parser   → Intercepts media commands
   ├─ THINK extraction
   ├─ Sentence streaming
...
```
speechAi/
├── nemotron_web_server.py        # Main server (includes YouTube command parser)
├── nemotron_web_ui.html          # Web UI (mobile responsive + YouTube player)
...
| YouTube not playing | Click 📺 button first to unlock audio; use direct URLs |
